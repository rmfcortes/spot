...
@NgModule({
    ...
    declarations: [ PreloadImageComponent, ScrollVanishDirective, TitleScrollVanishDirective ],
    exports: [ PreloadImageComponent, , ScrollVanishDirective, TitleScrollVanishDirective ]
  })
