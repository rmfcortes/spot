...
export class CategoriasService {
  ...
  setVisita(idNegocio: string) {
    this.db.object(`visitas/${idNegocio}`).query.ref.transaction(cantidad => cantidad ? cantidad + 1 : 1);
    this.db.object(`functions/${idNegocio}/visitas`).query.ref.transaction(cantidad => cantidad ? cantidad + 1 : 1);
  }
