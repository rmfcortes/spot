...
export class CategoriaPage implements OnInit {
  ...
  verNegocio(negocio: Negocio) {
    this.dataTemp.setNegocio(negocio);
    if (negocio.tipo === 'productos') {
      this.router.navigate([`negocio/${this.categoria}/${negocio.id}/${negocio.abierto}`]);
    } else {
      this.router.navigate([`negocio-servicios/${this.categoria}/${negocio.id}/${negocio.abierto}`]);
    }
  }
