...
export class TarjetaPage implements OnInit {
  ...
  agregarTarjeta() {
    ...
    if (!Conekta.card.validateNumber(newCard.number)) return this.tarjetaInvalida('Número de tarjeta inválido. Este número de tarjeta no corresponde a ningún número registrado');
