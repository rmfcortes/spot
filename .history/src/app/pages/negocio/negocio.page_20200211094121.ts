...
export class NegocioPage implements OnInit {
  ...
  async getPasillos() {
    ...
    const detalles: any = await this.negocioService.getPasillos(this.categoria, this.negocio.id);
    this.portada = detalles.portada;
    this.vista = detalles.vista;
    this.pasillos.pasillos = this.pasillos.pasillos.sort((a, b) => a.pasillos.prioridad - b.pasillos.prioridad);
