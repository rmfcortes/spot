  ...
  newCard(cliente): Promise<any> {
    return new Promise((resolve, reject) => {
      ...
      if (this.platform.is ('cordova')) {
        this.http.get('https://us-central1-revistaojo-9a8d3.cloudfunctions.net/request', cliente, {Authorization: 'secret-key-test'})
        ...
        const httpOptions = {
         ...
         this.httpAngular.get('https://us-central1-revistaojo-9a8d3.cloudfunctions.net/request', cliente, httpOptions)
         .subscribe(
          res => {
            resolve(res)
          },
